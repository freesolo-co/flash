...
Run the conformance suite with the same credential the backend was deployed with; pointing it at a
customer-owned endpoint means setting `FLASH_SERVING_KEY`.
