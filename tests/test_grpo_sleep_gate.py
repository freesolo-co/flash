...
def test_boot_alloc_conf_and_run_rl_share_sleep_resolver():
    import ast
    import inspect
    ...
    def _call_keywords(fn, call_name: str) -> set[str] | None:
    ...
    resolver_kws = _call_keywords(resolve_grpo_sleep_mode, "grpo_sleep_mode")
