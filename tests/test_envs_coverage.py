...
def test_env_init_scaffolds_a_loadable_freesolo_env(tmp_path, monkeypatch) -> None:
    """`flash env init` must scaffold a Freesolo SDK env, not a BaseEnvironment subclass."""
    ...
    assert "class CustomEnv(EnvironmentSingleTurn)" in source
