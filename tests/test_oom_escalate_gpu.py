...
def test_fenced_result_manifest_maps_oom_to_retry_classification():
    ...
    manifest = ResultManifest(
        ...
        checkpoint={},
        artifacts={},
        source_attestation={"kind": "test-attestation"},
        diagnostics={"error": "cuda oom"},
    )
