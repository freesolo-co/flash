...
# The root ``tests/conftest._offline`` autouse fixture DELETES the provider API keys (LAMBDA_API_KEY,
# RUNPOD_API_KEY, VAST_API_KEY) so the offline suite stays hermetic. Snapshot them at import time
