...
def _remove_fla() -> None:
    ...
    # later `pip install` reports "already satisfied" and skips the reinstall. Strip the metadata
    # from every site dir so a STACK=new run after STACK=old actually reinstalls fla.
