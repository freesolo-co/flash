...
`FREESOLO_DEPLOYMENT_ID`, `OPENROUTER_INFERENCE_KEY_SHA256_CURRENT`,
`OPENROUTER_SETTLEMENT_ORG_ID`, and `SERVING_CUSTOM_DOMAIN=serve.freesolo.co`.
`OPENROUTER_INFERENCE_KEY_SHA256_PREVIOUS` is optional.
