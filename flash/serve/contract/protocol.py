...
# both spellings of a text content block. request validation and tool-history detachment each
# classify blocks, so the set lives here rather than in either of them importing the other.
