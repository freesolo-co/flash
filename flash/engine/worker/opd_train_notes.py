"""OPD training-note assembly.

Split out of ``flash.engine.worker.opd_train_runner`` to keep that module under the file-size
limit. Pure data shaping over the child's final accounting: no i/o, no side effects.
"""
...
if TYPE_CHECKING:
    # annotations only, and importing these at runtime would be circular: the runner imports this
    # module. `from __future__ import annotations` keeps the signature unevaluated.
