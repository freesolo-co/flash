...
class _ScoreBatcher:
    ...
    one daemon thread batches pending requests after the oldest grace period, then scatters results
    in order. the env still receives one top-level call at a time.
    """
