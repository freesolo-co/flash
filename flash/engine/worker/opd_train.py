...
from flash.engine.worker.io import heartbeat as _heartbeat_mod
...
CHILD_STALL_ABORT_REASON = (
    f"opd child produced no new output for {round(_heartbeat_mod.CHILD_TAIL_STALL_S / 60)} minutes "
    "and had not completed its first optimizer step; the process group was torn down to release "
    "the gpu"
)
