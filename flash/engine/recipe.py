...
FORWARD_TEACHER_API_KEY_SECRET = "PARASAIL_API_KEY"
...
FORWARD_TEACHER_URL = "https://api.parasail.io/v1/chat/completions"
FORWARD_TEACHER_MODEL_ID = "deepseek-ai/DeepSeek-V4-Pro"
