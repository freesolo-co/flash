...
# ever needed. Used on both Vast and RunPod. FLASH_TRAIN_WORKER_IMAGE overrides the tag (e.g. to
...
# .strip() so a whitespace-only FLASH_TRAIN_WORKER_IMAGE falls back to the default tag instead of
