...
def resolve_environment_source(
    ...
    *,
    ...
    from flash.envs.identity import GitHubEnvironmentRef, is_commit_sha
...
def _validated_manifest_entrypoint(
    ...
    from flash.envs.identity import _normalize_env_path, canonical_environment_id
...
def load_staged_freesolo_environment(
    ...
    *,
    ...
    from flash.envs.loader import _load_resolved_freesolo_environment
