...
class RunStatus:
    ...
    def to_dict(self) -> dict:
        ...
        # internal warm-start preparation and provider billing identities never leave the server
...
def _save_status_unlocked(
    ...
    *,
    ...
    from flash.runner.accounting.reconciliation import _merge_provider_cost_history
