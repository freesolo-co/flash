...
| `flash/server/`    | the FastAPI control plane — run submission, auth, project scoping, trace recording |
...
path and proxy-style chat trace recording are self-hostable end to end — see
