...
- **Freesolo SDK environments.** Every run names a GitHub-backed Freesolo
  environment ref (`[environment] id = "github:owner/repo@main:path/to/freesolo/environment.py"`).
